...
export class PersonalInformationComponent implements OnInit {
    ...
    public patientKeysToShowRow: string[] = ['name', 'nhc', 'healthCard', 'dni', 'phone', 'genderCode'];
    public patientKeysToShow: string[] = ['name', 'nhc', 'healthCard', 'dni', 'address', 'phone', 'email', 'genderCode', 'birthDate', 'age'];
    ...
    constructor(private _patientService: PatientsService, private _translate: TranslateService) {}
