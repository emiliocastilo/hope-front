...
export class NapsiComponent implements OnInit {
    ...
    constructor(private _notification: NotificationService, private _formBuilder: FormBuilder, private _formsService: FormsService, public _translate: TranslateService, private _napsiService: NapsiService, private _modalService: NgbModal) {
        this.DontPush = false;
    }
