...
export class MedicinesService {
    ...
    get(queryParams?: string): Observable<QueryResult<MedicineModel>> {
        ...
        return this._http.get<QueryResult<MedicineModel>>(`${this.endpoint}${queryParams}`);
    }
    ...
    getSearch(search?: string) {
        return this._http.get<QueryResult<MedicineModel>>(`${this.endpoint}/searches?search=${search}`);
    }
    ...
    saveFromFile(medicineModel: any): any {
        ...
        formdata.append('multipartFile', medicineModel.fileMedicine, medicineModel.fileMedicine.name);
