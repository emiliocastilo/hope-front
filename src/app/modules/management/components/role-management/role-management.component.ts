...
export class RoleManagementComponent implements OnInit {
    ...
    public onSearch(event: string): void {
        this._roleManagementService.getRolSearches(`${event}&size=${this.paginationData.size}`).subscribe((data: any) => {
    ...
    private saveOrUpdate(event: any, modalRef: any): void {
        ...
        const rol: RolModel = new RolModel(id, formValues.name, formValues.description, formValues.service, formValues.hospital, formValues.pathology);
    ...
    private showModalConfirm() {
        ...
        modalRef.componentInstance.messageModal = `¿Estás seguro de que quieres eliminar el rol ${this.roles[this.selectedItem].name}?`;
    ...
    public deleteRole(): void {
        this._roleManagementService.deleteRole(this.roles[this.selectedItem].id).subscribe(
            (response) => {
