...
@Component({
  selector: 'app-psoriasis-pustulosa',
  templateUrl: './psoriasis-pustulosa.component.html',
  styleUrls: ['./psoriasis-pustulosa.component.scss'],
})
export class PsoriasisPustulosaComponent implements OnInit {
  ...
  public onIconButtonClick(event: any) {
    if (event && event.type === 'detail') {
      ...
      const query = 'type=PSORIASIS PULTULOSA&indication=';
