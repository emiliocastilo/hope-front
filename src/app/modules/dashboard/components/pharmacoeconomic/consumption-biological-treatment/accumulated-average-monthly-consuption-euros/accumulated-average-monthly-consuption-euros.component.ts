...
export class AccumulatedAverageMonthlyConsuptionEurosComponent implements OnInit {
    ...
    constructor(private _graphService: GraphsService, private _router: Router, private _translate: TranslateService) {}
    ...
    public onFormSubmit(): void {
        ...
        if (data[lastPosition].name === this._translate.instant('yearlyGoalValue')) {
            data.splice(-1, 1);
