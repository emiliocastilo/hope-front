...
export class PatientsByPgaComponent implements OnInit {
  ...
  public columHeaders: string[] = ['resultsPGA', 'patients'];
  ...
  public onIconButtonClick(event: any): void {
    if (event.type === 'detail') {
      ...
      const query = `indexType=PGA&result=${this.currentSelected.resultsPGA}`;
  ...
  public selectPage(page: number) {
    if (this.currentPage !== page) {
      ...
      const query = `indexType=PGA&result=${this.currentSelected.resultsPGA}&page=${this.currentPage}&sort=${this.currentSort.column},${this.currentSort.direction}`;
      this.getDetails(query);
    }
  }

  public onSort(event: any) {
    const query = `indexType=PGA&result=${this.currentSelected.resultsPGA}&page=${this.currentPage}&sort=${event.column},${event.direction}`;
