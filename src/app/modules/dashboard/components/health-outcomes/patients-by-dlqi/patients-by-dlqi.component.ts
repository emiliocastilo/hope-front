...
export class PatientsByDlqiComponent implements OnInit {
  ...
  public columHeaders: string[] = ['resultsDLQI', 'patients'];
  ...
  public onIconButtonClick(event: any): void {
    if (event.type === 'detail') {
      ...
      const query = `indexType=DLQI&result=${this.currentSelected.resultsDLQI}`;
  ...
  public selectPage(page: number) {
    if (this.currentPage !== page) {
      ...
      const query = `indexType=DLQI&result=${this.currentSelected.resultsDLQI}&page=${this.currentPage}&sort=${this.currentSort.column},${this.currentSort.direction}`;
      this.getDetails(query);
    }
  }

  public onSort(event: any) {
    const query = `indexType=DLQI&result=${this.currentSelected.resultsDLQI}&page=${this.currentPage}&sort=${event.column},${event.direction}`;
