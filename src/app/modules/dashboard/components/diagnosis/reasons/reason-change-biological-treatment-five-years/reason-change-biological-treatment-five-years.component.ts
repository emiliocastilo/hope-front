...
export class ReasonChangeBiologicalTreatmentFiveYearsComponent implements OnInit {
    public showingDetail: boolean = false;
    public dataChart: ChartObjectModel[];
    public dataTable: any[];
    private treatments: any;
    public actions: TableActionsModel[] = new TableActionsBuilder().getDetail();
    public columHeaders: string[] = ['reasonChangeBiologicalTreatmentFiveYears', 'patients'];
    ...
    private getTreatments(): void {
        this._graphService.getReasonLastChangeBiologicalFiveYears(this.endCause).subscribe(
            (data) => {
    ...
    private getDetails(query: string): void {
        this._graphService.getReasonLastChangeBiologicalDetailsFiveYears(query).subscribe(
            (data: any) => {
    ...
    private getDetailsToExport(query: string) {
        this._graphService.getReasonLastChangeBiologicalDetailsExportFiveYears(query).subscribe(
            (data: any) => {
