...
export class ChangePasswordModalComponent implements OnInit {
    ...
    constructor(private _formBuilder: FormBuilder, private _loginService: LoginService, public _notification: NotificationService) {}
    ...
    public getInvalidLabel(formKey: string): string {
        const errors = this.userDataForm ? this.userDataForm.get(formKey).errors : undefined;
