...
export class FileUtils {
    static checkValidExtension(file: File, validExtensions: Array<string>, _translate: TranslateService, _notification: NotificationService): boolean {
    ...
    static checkFileSize(file: File, fileSize: number, _translate: TranslateService, _notification: NotificationService): boolean {
        let isValid = false;
